...
namespace Dk.Odense.SSP.Gdf.Model
{
    ...
    public class AvaProd : IAva
    {
        ...
        [Column("fcd1cc29-9107-4d44-eefe-45143b2df7f5")] //Din mailadresse
        ...
        //[Column("43a9c042-ae8c-4b8b-fc03-0622e9a48a7f")] 
        [NotMapped]//Din nærmeste leders mailadresse
        ...
        [Column("86631D40-7713-4AA6-8CED-016469678587")]
        public string ReplyRecipientName { get; set; }
        //Mailadresse på modtager af tilbagemeldingen
        [Column("6459A0A8-9071-47A5-CBCF-70DC5F0ACBE7")]
