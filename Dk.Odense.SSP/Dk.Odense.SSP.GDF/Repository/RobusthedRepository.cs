...
{
    public class RobusthedRepository<TValue> : IGdfRepository<TValue> where TValue : class, IRobusthed, new()
    {
        private readonly GdfDbContext<TValue> databaseContext;
        private readonly DbSet<TValue> dbSet;

        public RobusthedRepository(GdfDbContext<TValue> databaseContext)
        {
