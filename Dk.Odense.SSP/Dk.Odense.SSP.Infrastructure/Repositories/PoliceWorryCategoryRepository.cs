...
{
    public class PoliceWorryCategoryRepository : BaseRepository<PoliceWorryCategory>, IPoliceWorryCategoryRepository
    {
        public PoliceWorryCategoryRepository(IDatabaseContext databaseContext) : base(databaseContext)
        {
        }
