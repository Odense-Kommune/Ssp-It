...
{
    public class PoliceWorryRoleRepository : BaseRepository<PoliceWorryRole>, IPoliceWorryRoleRepository
    {
        public PoliceWorryRoleRepository(IDatabaseContext databaseContext) : base(databaseContext)
        {
        }
